...
const libraries: IndexCardProps[] = [
  ...
  },
  {
    ...
    description:
      'ESLint and Prettier can be used to enforce codestyle across the project. Run the lint run configuration or setup automatic linting depending on your code editor.',
  ...
  },
  {
    ...
    hrefExample: undefined,
    additionalLinks: [
      { label: 'Docs 2', href: 'https://github.com/i18next/next-i18next' },
      { label: 'Docs NextJS', href: 'https://nextjs.org/docs/advanced-features/i18n-routing' },
    ],
  },
  {
    ...
    <div>
      ...
      <Container className={styles.content} sx={{ my: 2 }}>
        ...
        >
          ...
          <Typography variant="h5">{t('appDescription')}</Typography>
        </Box>

        <Typography sx={{ my: 3 }}>{t('getStarted', { path: '/src/pages/index.tsx' })}</Typography>
